...
%        <Item name="Mean Sq. Disp. DiGraph" icon="Matlab" tooltip="Plot mean square displacement for the tracks.">
%          <Command>MatlabXT::XTTrackPlotMSDgraph(%i)</Command>
%        </Item>
%       </Submenu>
%      </Menu>
%      <SurpassTab>
...
function XTTrackPlotMSDgraph(aImarisApplicationID,aThreshold)
...
figure;
hold on;
A=digraph(vEdges(1,:),vEdges(2,:));
vStart = (indegree(A) == 0);
vEnd = (outdegree(A) == 0);
for idx=1:length(vStart)
	for jdx = 1:length(vEnd)
