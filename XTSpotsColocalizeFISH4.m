...
%   identify those that are not colocalized. This works for up to 4 sets.
% 
%
...
% final designation as quadruples using the forced association above
...
% % double spots
% vNewSpots1 = vImarisApplication.GetFactory.CreateSpots;
% vNewSpots1.Set(vSpotsXYZ1(v1double, :), vTime1(v1double), zeros(sum(v1double),1));
% vNewSpots1.SetRadiiXYZ(vRadius1(v1double,:));
% vNewSpots1.SetName([char(vSpots1.GetName), ' doubles']);
% vRGBA = vSpots1.GetColorRGBA;
% vNewSpots1.SetColorRGBA(vRGBA);
% vSpotsGroup.AddChild(vNewSpots1, -1);

% vNewSpots2 = vImarisApplication.GetFactory.CreateSpots;
% vNewSpots2.Set(vSpotsXYZ2(v2double, :), vTime2(v2double), zeros(sum(v2double),1));
% vNewSpots2.SetRadiiXYZ(vRadius2(v2double,:));
% vNewSpots2.SetName([char(vSpots2.GetName), ' doubles']);
% vRGBA = vSpots2.GetColorRGBA;
% vNewSpots2.SetColorRGBA(vRGBA);
% vSpotsGroup.AddChild(vNewSpots2, -1);

% vNewSpots3 = vImarisApplication.GetFactory.CreateSpots;
% vNewSpots3.Set(vSpotsXYZ3(v3double, :), vTime3(v3double), zeros(sum(v3double),1));
% vNewSpots3.SetRadiiXYZ(vRadius3(v3double,:));
% vNewSpots3.SetName([char(vSpots3.GetName), ' doubles']);
% vRGBA = vSpots3.GetColorRGBA;
% vNewSpots3.SetColorRGBA(vRGBA);
% vSpotsGroup.AddChild(vNewSpots3, -1);
